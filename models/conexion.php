...
Class Conexion{
    static public function conectar(){
        ...
        En XAMPP phpMyAdmin encontramos en la casita icono el nùmero del servidor y aparece siempre con una numeraciòn: -127.0.0.1- o en su defecto: localhost y eso se coloca en la funciòn como argumento dbname (paràmetro de la base de datos como lo escribiste en phpMyAdmin -en tu caso, registro_usuarios-)
        ...
        "root", #Nombre de ususario del servidor (" "); #contraseña (en este caso no tiene contraseña el ususario llamado root)
...
/*=============================================================================
    CONEXIÒN SERVIDOR INSTANCIADA EN EL CONTROLLADORES VARIOS DEL CRUD A BD
===============================================================================*/
Class Conexion{
    static public function conectar(){
